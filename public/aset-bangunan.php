...
$search = (isset($_GET['search']) && $_GET['search']!=null) ? "WHERE jenis_bangunan LIKE '%$getsearch%'" : '';

$options = array(  
    'url'        	=> host().'/aset-bangunan?page=*VAR*',  
    'db_handle'  	=> $db 
);  
  
$pagination = new pagination($page, 'SELECT * FROM aset_bangunan '.$search.' ORDER BY tgl_input ASC', $options);
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
  <div class="col-auto">
        <h1 class="app-page-title mb-0">Aset Desa Berupa Bangunan</h1>
  </div>
  <div class="col-auto">
     <div class="page-utilities">
	    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
		    ...
		    <div class="col-auto">				    
			    <a class="btn app-btn-secondary" href="/aset-bangunan/tambah">
				    <i class="bi bi-file-earmark-plus"></i> Tambah
				</a>				    
			    <a class="btn app-btn-secondary" href="/aset-bangunan/status">
				    <i class="bi bi-pencil-square"></i> Status
				</a>
			    <a class="btn app-btn-secondary" href="/aset-bangunan/filter">
      ...
      <table class="table app-table-hover mb-0 text-left">
			<thead class="text-nowrap">
				<tr>
					...
					<th class="cell">Luas</th>
					<th class="cell">Tahun Perolehan</th>
					<th class="cell">Tipe Bangunan</th>
			...
			<tbody class="text-nowrap">
				...
				<tr>
					<td class="cell">
						<a class="me-1" href="/aset-bangunan/edit?id=<?=$row['id_bangunan']?>"><i class="bi bi-pencil-square"></i></a>
						<a class="text-danger del" href="/proses/aset-bangunan/hapus?id=<?=$row['id_bangunan']?>"><i class="bi bi-x-square"></i></a>
					</td>
					<td class="cell"><span class="badge bg-secondary"><?=$row['kode_bangunan']?></span></td>
					<td class="cell"><?=$row['jenis_bangunan']?></td>
					<td class="cell"><?=$row['nup']?></td>
					<td class="cell"><?=$row['luas']?></td>
					<td class="cell"><?=$row['tahun_perolehan']?></td>
					<td class="cell"><?=$row['type_bangunan']?></td>
					<td class="cell"><?=toRp($row['nilai'])?></td>
