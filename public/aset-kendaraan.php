...
$search = (isset($_GET['search']) && $_GET['search']!=null) ? "WHERE nama_kendaraan LIKE '%$getsearch%'" : '';

$options = array(  
    'url'        	=> host().'/aset-kendaraan?page=*VAR*',  
    'db_handle'  	=> $db 
);  
  
$pagination = new pagination($page, 'SELECT * FROM aset_kendaraan '.$search.' ORDER BY tgl_input ASC', $options);
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
  <div class="col-auto">
        <h1 class="app-page-title mb-0">Aset Desa Berupa Kendaraan Bermotor</h1>
  </div>
  <div class="col-auto">
     <div class="page-utilities">
	    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
		    ...
		    <div class="col-auto">				    
			    <a class="btn app-btn-secondary" href="/aset-kendaraan/tambah">
				    <i class="bi bi-file-earmark-plus"></i> Tambah
				</a>				    
			    <a class="btn app-btn-secondary" href="/aset-kendaraan/status">
				    <i class="bi bi-pencil-square"></i> Status
				</a>
			    <a class="btn app-btn-secondary" href="/aset-kendaraan/filter">
      ...
      <table class="table app-table-hover mb-0 text-left">
			<thead class="text-nowrap">
				<tr>
					...
					<th class="cell">Nama Kendaraan</th>
					<th class="cell">NUP</th>
					<th class="cell">Merk Type</th>
					<th class="cell">Tahun</th>
			...
			<tbody class="text-nowrap">
				...
				<tr>
					<td class="cell">
						<a class="me-1" href="/aset-kendaraan/edit?id=<?=$row['id_kendaraan']?>"><i class="bi bi-pencil-square"></i></a>
						<a class="text-danger del" href="/proses/aset-kendaraan/hapus?id=<?=$row['id_kendaraan']?>"><i class="bi bi-x-square"></i></a>
					</td>
					<td class="cell"><span class="badge bg-secondary"><?=$row['kode_kendaraan']?></span></td>
					<td class="cell"><?=$row['nama_kendaraan']?></td>
					<td class="cell"><?=$row['nup']?></td>
					<td class="cell"><?=$row['merk_type']?></td>
					<td class="cell"><?=$row['tahun_perolehan']?></td>
					<td class="cell"><span class="truncate"><?=$row['nomor_identitas']?></span></td>
