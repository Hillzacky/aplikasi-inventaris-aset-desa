...
$asets = $db->query("SELECT * FROM aset_irigasi WHERE nup='$nup' AND status='$stat' AND tgl_input BETWEEN '$sd' AND '$ed'");
$tims = $db->query("SELECT * FROM tim_inventarisasi WHERE aset_kategori='Jalan Irigasi dan Jaringan' AND no_pengajuan='$nup'");
  ...
  <body class="p-2">
    ...
    <div>
      <h3 class="text-center">
          <?php if($stat==1){
                echo "Rekap Permintaan Aset Desa (RPA)<br>Berupa Jalan Irigasi dan Jaringan";
              }elseif($stat==2){
                echo "Laporan Hasil Inventarisasi (LHI) Aset Desa<br>Berupa Jalan Irigasi dan Jaringan";
              }elseif($stat==3){
                echo "Rekap Permintaan Aset Desa Berupa Jalan Irigasi dan Jaringan<br>Yang Tidak Terealisasi";
          }?>
      </h3>
    </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?=$aset['kode_irigasi']?></td>
              <td><?=$aset['jenis_irigasi']?></td>
              <td><?=$aset['ukuran']?></td>
