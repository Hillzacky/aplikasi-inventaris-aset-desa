...
$asets = $db->query("SELECT * FROM aset_peralatan WHERE nup='$nup' AND status='$stat' AND tgl_input BETWEEN '$sd' AND '$ed'");
$tims = $db->query("SELECT * FROM tim_inventarisasi WHERE aset_kategori='Peralatan dan Mesin' AND no_pengajuan='$nup'");
  ...
  <body class="p-2">
    ...
    <div>
      <h3 class="text-center">
          <?php if($stat==1){
                echo "Rekap Permintaan Aset Desa (RPA)<br>Berupa Peralatan dan Mesin";
              }elseif($stat==2){
                echo "Laporan Hasil Inventarisasi (LHI) Aset Desa<br>Berupa Peralatan dan Mesin";
              }elseif($stat==3){
                echo "Rekap Permintaan Aset Desa Berupa Peralatan dan Mesin<br>Yang Tidak Terealisasi";
          }?>
      </h3>
    </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?=$aset['kode_peralatan']?></td>
              <td><?=$aset['nama_peralatan']?></td>
              <td><?=$aset['merk_type']?> m²</td>
