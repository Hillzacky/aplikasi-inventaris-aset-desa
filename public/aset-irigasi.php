...
$search = (isset($_GET['search']) && $_GET['search']!=null) ? "WHERE jenis_irigasi LIKE '%$getsearch%'" : '';

$options = array(  
    'url'        	=> host().'/aset-irigasi?page=*VAR*',  
    'db_handle'  	=> $db 
);  
  
$pagination = new pagination($page, 'SELECT * FROM aset_irigasi '.$search.' ORDER BY tgl_input ASC', $options);
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
  <div class="col-auto">
        <h1 class="app-page-title mb-0">Aset Desa Jalan Irigasi & Jaringan</h1>
  </div>
  <div class="col-auto">
     <div class="page-utilities">
	    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
		    ...
		    <div class="col-auto">				    
			    <a class="btn app-btn-secondary" href="/aset-irigasi/tambah">
				    <i class="bi bi-file-earmark-plus"></i> Tambah
				</a>				    
			    <a class="btn app-btn-secondary" href="/aset-irigasi/status">
				    <i class="bi bi-pencil-square"></i> Status
				</a>
			    <a class="btn app-btn-secondary" href="/aset-irigasi/filter">
    ...
    <div class="table-responsive">
      <table class="table app-table-hover mb-0 text-left">
			...
			<tbody class="text-nowrap">
				...
				<tr>
					<td class="cell">
						<a class="me-1" href="/aset-irigasi/edit?id=<?=$row['id_irigasi']?>"><i class="bi bi-pencil-square"></i></a>
						<a class="text-danger del" href="/proses/aset-irigasi/hapus?id=<?=$row['id_irigasi']?>"><i class="bi bi-x-square"></i></a>
					</td>
					<td class="cell"><span class="badge bg-secondary"><?=$row['kode_irigasi']?></span></td>
					<td class="cell"><?=$row['jenis_irigasi']?></td>
					<td class="cell"><?=$row['nup']?></td>
					<td class="cell"><?=$row['ukuran']?></td>
