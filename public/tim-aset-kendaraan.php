...
$options = array(  
    'url'        	=> host().'/tim-aset-kendaraan?page=*VAR*',  
    'db_handle'  	=> $db 
);  
  
$pagination = new pagination($page, "SELECT * FROM tim_inventarisasi WHERE aset_kategori='Kendaraan Bermotor' {$search} ORDER BY id_tim ASC", $options);
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
  <div class="col-auto">
        <h1 class="app-page-title mb-0">Tim Aset Desa Berupa Kendaraan Bermotor</h1>
  </div>
  <div class="col-auto">
     <div class="page-utilities">
	    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
		    ...
		    <div class="col-auto">						    
			    <a class="btn app-btn-secondary" href="/tim-aset-kendaraan/tambah">
    ...
    <div class="table-responsive">
      <table class="table app-table-hover mb-0 text-left">
			...
			<tbody class="text-nowrap">
				...
				<tr>
					<td class="cell">
						<a class="me-1" href="/tim-aset-kendaraan/edit?id=<?=$row['id_tim']?>"><i class="bi bi-pencil-square"></i></a>
						<a class="text-danger del" href="/proses/tim-aset-kendaraan/hapus?id=<?=$row['id_tim']?>" data-confirm="Yakin hapus <?=$row['nama_tim']?>?"><i class="bi bi-x-square"></i></a>
					</td>
