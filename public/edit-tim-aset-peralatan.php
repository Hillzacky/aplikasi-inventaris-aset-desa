...
$id = isset($_GET['id'])&&($_GET['id']!==null) ? (int) $_GET['id'] : header('Location: /tim-aset-peralatan');
$q = $db->query("SELECT * FROM tim_inventarisasi WHERE id_tim=$id");
$rows = $q->fetch_all(MYSQLI_ASSOC);$row = $rows[0];
include 'components/header.php'?>

				<h1 class="app-page-title">Perbarui Tim Aset Peralatan &amp; Mesin</h1>
				<hr class="mb-4">
          ...
          <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
					    ...
					    <div class="app-card-body">
						    <form class="form-peralatan" method="post" action="/proses/tim-aset-peralatan/edit">
								...
								<input type="hidden" class="form-control" name="aset_kategori" value="Peralatan dan Mesin">
							    <div class="mb-3">
