...
$asets = $db->query("SELECT * FROM aset_tanah WHERE nup='$nup' AND status='$stat' AND tgl_input BETWEEN '$sd' AND '$ed'");
$tims = $db->query("SELECT * FROM tim_inventarisasi WHERE aset_kategori='Tanah' AND no_pengajuan='$nup'");
  ...
  <body class="p-2">
    ...
    <div>
      <h3 class="text-center">
          <?php if($stat==1){
                echo "Rekap Permintaan Aset Desa (RPA)<br>Berupa Tanah";
              }elseif($stat==2){
                echo "Laporan Hasil Inventarisasi (LHI) Aset Desa<br>Berupa Tanah";
              }elseif($stat==3){
                echo "Rekap Permintaan Aset Desa Berupa Tanah<br>Yang Tidak Terealisasi";
          }?>
      </h3>
    </div>
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th scope="col">Bukti Kepemilikan</th>
