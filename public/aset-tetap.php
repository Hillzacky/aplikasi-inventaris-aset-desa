...
$search = (isset($_GET['search']) && $_GET['search']!=null) ? "WHERE nama_tetap LIKE '%$getsearch%'" : '';

$options = array(  
    'url'        	=> host().'/aset-tetap?page=*VAR*',  
    'db_handle'  	=> $db 
);  
  
$pagination = new pagination($page, 'SELECT * FROM aset_tetap '.$search.' ORDER BY tgl_input ASC', $options);
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
  <div class="col-auto">
        <h1 class="app-page-title mb-0">Aset Desa Berupa Aset Tetap Lainnya</h1>
  </div>
  <div class="col-auto">
     <div class="page-utilities">
	    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
		    ...
		    <div class="col-auto">						    
			    <a class="btn app-btn-secondary" href="/aset-tetap/tambah">
    ...
    <div class="table-responsive">
      <table class="table app-table-hover mb-0 text-left">
			...
			<tbody class="text-nowrap">
				...
				<tr>
					<td class="cell">
						<a class="me-1" href="/aset-tetap/edit?id=<?=$row['id_tetap']?>"><i class="bi bi-pencil-square"></i></a>
						<a class="text-danger" href="/proses/aset-tetap/hapus?id=<?=$row['id_tetap']?>"><i class="bi bi-x-square"></i></a>
					</td>
					<td class="cell"><span class="badge bg-secondary"><?=$row['kode_tetap']?></span></td>
					<td class="cell"><?=$row['nama_tetap']?></td>
